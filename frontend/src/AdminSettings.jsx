...
const Settings = () => {
  ...
  const [currentAdmin, setCurrentAdmin] = useState(localStorage.getItem("currentAdmin")); // Logged-in Admin
  ...
  const handleAddAdmin = () => {
    ...
    if (!admins.includes(currentAdmin)) return alert("Only admins can add new admins.");
  ...
  const handleChangePassword = () => {
    ...
    if (storedPassword !== oldPassword) return alert("Old password is incorrect!");
  ...
  return (
    <div className="p-4">
      ...
      <div className="mb-6">
        ...
        />
        <button onClick={handleAddAdmin} className="bg-blue-500 text-white px-3 py-2 rounded mt-2">
          Add Admin
        </button>
      </div>
      ...
      <div className="mb-6">
        ...
        <input 
          ...
          className="border p-2 rounded w-full"
        />
        <button onClick={handleChangePassword} className="bg-green-500 text-white px-3 py-2 rounded mt-2">
          Change Password
        </button>
      </div>
