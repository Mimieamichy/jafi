    ...
    const fetchHires = async () => {
      try {
        const res = await fetch(
          `${baseUrl}/service/?page=${page}&limit=${limit}&filter=${sortOption}`
        );
...
function UserCard({ user, onClick }) {
  return (
    <div
      className="bg-white shadow-lg rounded-lg overflow-hidden w-full h-full cursor-pointer hover:shadow-xl transition"
      onClick={onClick}
    >
